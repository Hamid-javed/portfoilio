...
const projects: Project[] = [
  {
    ...
    skills: {
      ...
      backend: [PROJECT_SKILLS.node, PROJECT_SKILLS.netlify],
    },
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
            I developed a full-stack learning platform where users can browse
            and access courses uploaded by mentors across various topics. Using
            React.js for the frontend and Node.js with MongoDB Atlas for backend
            efficiency, the platform ensures seamless data handling. The
            responsive design, built with Tailwind CSS and CSS, ensures
            accessibility on all devices. With JavaScript and supporting
            libraries, the platform offers a smooth and user-friendly
            experience.
          </TypographyP>
          <ProjectsLinks
  ...
  {
    id: "NeuroMail",
    category: "Secure Email Services",
    title: "NeuroMail",
    src: "/assets/neuroMail.png",
    screenshots: ["1.png"],
    skills: {
      frontend: [
        PROJECT_SKILLS.vite,
    ...
    get content() {
      return (
        <div>
          ...
          <TypographyP className="font-mono ">
            Neuromail is a responsive, Gmail-like email platform. I built the
            frontend with React.js and Tailwind CSS using a mobile-first
            approach. I collaborated with backend developers to integrate
            RESTful APIs and ensure smooth data flow. The app was optimized for
            performance and deployed to a cloud environment for production use.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          {/* <TypographyH3 className="my-4 mt-8">Architecture</TypographyH3>
          <p className="font-mono mb-2">
  ...
  {
    id: "NeuroDrive",
    category: "Encrypted File Storage / Privacy Tech",
    title: "NeuroDrive",
    src: "/assets/neuroDrive.png",
    screenshots: ["landing.png"],
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
            NeuroDrive is a secure cloud storage platform offering file
            encryption, password-protected sharing, and online editing for PDF,
            Word, and Excel files. I developed the frontend using React.js and
            Tailwind CSS, integrated RESTful APIs, and ensured a fully
            responsive, user-friendly interface for managing, editing, and
  ...
  },
  {
    ...
    src: "/assets/E-learn-admin.png",
    screenshots: ["01.jpeg", "03.png"],
    live: "https://e-learn-admin.netlify.app/",
    github: "https://github.com/Hamid-javed/E-Learn-Admin.git",
    skills: {
      frontend: [
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
            This is the admin panel for the E-Learning platform. Here, the admin
            can add new courses, delete existing courses, update course details,
            add new mentors, and remove existing mentors. Admins can also access
            user data, including purchased courses and courses in wishlists.
            Additionally, this admin panel provides graphical data on metrics
            such as monthly bought courses, most liked courses, most reviewed
            courses, and monthly sales. This admin panel allows for complete
            control of the E-Learning platform. It is fully responsive and
  ...
  },
  {
    ...
    github: "https://github.com/Hamid-javed/Chat-Bot",
    skills: {
      frontend: [
        PROJECT_SKILLS.ts,
        PROJECT_SKILLS.next,
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
            The AI-powered chatbot, built with Vite and TypeScript, provides
            real-time interactions using natural language processing. It
            features a responsive UI, efficient state management, and seamless
            API integration for smooth and dynamic conversations. Designed for
            speed and scalability, it ensures quick responses and an intuitive
            user experience.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          {/* <SlideShow
  ...
  },
  {
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
            A landing page for a social media Application. Its a single page
            website build using react.js and tailwind CSS from figma design.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          {/* <SlideShow
            images={[
  ...
  },
  {
    ...
    screenshots: ["01.png", "02.png", "03.png", "04.png"],
    live: "https://github.com/Hamid-javed/link-up.git",
    // github: "",
    skills: {
      frontend: [],
      backend: [PROJECT_SKILLS.js, PROJECT_SKILLS.node, PROJECT_SKILLS.express],
    },
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
            The backend for this social media application is built with Node.js
            and MongoDB, providing a scalable foundation for user interactions
            and data management. It features user authentication, post
            management, commenting, liking, real-time notifications, and a chat
            system, all accessible through a robust RESTful API. This
            architecture ensures high performance and security, making it ideal
            for a dynamic social media platform
          </TypographyP>
          {/* <ProjectsLinks live={this.live} repo={this.github} /> */}
          {/* <SlideShow
            images={[
  ...
  //   screenshots: ["01.png", "02.png", "03.png", "04.png"],
  //   live: "https://github.com/Hamid-javed/link-up.git",
  //   // github: "https://github.com/Hamid-javed/link-up.git",
  //   skills: {
  //     frontend: [],
  //     backend: [PROJECT_SKILLS.js, PROJECT_SKILLS.node, PROJECT_SKILLS.express],
  //   },
